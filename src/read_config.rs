...
use crate::{
    main_thread::{BoxErr, BuadRate, Config, ProcessorInfo},
...
impl Config {
    pub fn save_config_file(self) -> Result<Self, Box<dyn Any + Send>> {
...
impl Config {
    pub fn read_config_file(
        dir_entry_res: Result<DirEntry, Box<dyn Any + Send>>,
        procs: &[ProcessorInfo],
    ) -> Result<Config, Box<dyn Any + Send>> {
